...
class DatasetBuilder(abc.ABC):
    ...
    def __init__(
        ...
        x_lb: Optional[float] = None,
        x_ub: Optional[float] = None,
    ) -> None:
        
        assert x_normalize_method in ["min-max", "z-score", "ub-lb"]
    ...
    def normalize_x(self, x, normalization_method=None):
        ...
        if normalization_method is None:
            normalization_method = self.x_normalize_method
    ...
    def normalize_y(self, y, normalization_method=None):
        ...
        if self.y_mean is None or self.y_standard_dev is None:
            self.update_y_statistics()
        if normalization_method is None:
            normalization_method = self.y_normalize_method
        # normalize the prediction values
        if normalization_method == "z-score":
