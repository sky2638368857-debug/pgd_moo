...
class Task(object):
    ...
    def __init__(self, dataset: Union[DatasetBuilder, type, str],
        ...
        #kwargs["x_lb"] = self.problem.lbound.min()
        #kwargs["x_ub"] = self.problem.ubound.max()
        #self.lb = self.problem.lbound.min()
        #self.ub = self.problem.ubound.max()
        # if self.entry_point is a function call it
        if callable(dataset):
    ...
    def normalize_x(self, x, normalization_method=None):
        ...
        return self.dataset.normalize_x(x, normalization_method=normalization_method)
    ...
    def denormalize_x(self, x, normalization_method=None):
        ...
        return self.dataset.denormalize_x(x, normalization_method=normalization_method)

    def denormalize_y(self, y, normalization_method=None):
        """a function that un-standardizes the prediction values 'y' which
        ...
        return self.dataset.denormalize_y(y, normalization_method=normalization_method)
